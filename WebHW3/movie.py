...
class movie:
    def __init__(self, info, overview, alist):
        self.infolist = []
        self.reviewgroup = []
        self.overview = {}
        for line in info:
...
class MainHandler(tornado.web.RequestHandler):
    def get(self,input):
        ...
        f1= open(allpathInfo,'r')
        f2 = open(allpathOver,'r')
        review = []
...
if __name__ == "__main__":
    ...
    """app = tornado.web.Application(Application())"""
